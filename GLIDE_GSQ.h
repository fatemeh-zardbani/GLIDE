...
void RTREE_QUAL::ripple_lite_v2(float* this_tba_mins, float* this_tba_maxes, int* this_tba_ids, int this_tba_count, Node* this_leaf, vector<pair<Node*, Branch>> *leaves_to_add_later){
    ...
    if(this_leaf->m_R - this_leaf->m_L - this_leaf->m_holes > MOVING_THRESHOLD && (k < (this_leaf->m_R - this_leaf->m_L))){
        ...
        int percentile = floor(SAMPLE_SIZE*(this_R-this_L-k)/ (this_R-this_L-this_holes));
        ...
        if((stochastic_crack_index - this_L) < (this_R - stochastic_crack_index)){
            ...
            while((stochastic_crack_index - this_L) < k){
                // re crack on the right piece/bigger piece
                if((stochastic_crack_index - this_L) < (this_R - stochastic_crack_index)){
                    fake_this_L = stochastic_crack_index;
                    percentile = floor(SAMPLE_SIZE*((k - (stochastic_crack_index - this_L - this_holes)))/ (fake_this_R-fake_this_L));
                }
            ...
            while((this_R - stochastic_crack_index + this_holes) < k){
                // crack on the left piece

                if((stochastic_crack_index - this_L) >= (this_R - stochastic_crack_index)){
                    fake_this_R = stochastic_crack_index;
                    percentile = floor(SAMPLE_SIZE*(fake_this_R-fake_this_L-(k - (this_R - stochastic_crack_index)))/ (fake_this_R-fake_this_L));
                }
        ...
        if(this_R - stochastic_crack_index < (stochastic_crack_index - this_L - this_holes)){
            ...
            if(this_holes + this_R - stochastic_crack_index >= k){
                ...
                ASSERT(stochastic_crack_index - this_L >= k);
            ...
            if(stochastic_crack_index - this_L >= k){
                ...
                ASSERT(this_holes + this_R - stochastic_crack_index >= k);
